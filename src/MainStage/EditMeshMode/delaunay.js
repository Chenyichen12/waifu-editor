...
function getBound(points) {
    const xList = points.map((v) => {
        return v.x;
    })
    const yList = points.map((v) => {
        return v.y
    })
    const left = Math.min(...xList);
    const top = Math.min(...yList);
    const width = Math.max(...xList) - left;
    const height = Math.max(...yList) - top;
    return {
...
class Delaunay {
    constructor(points) {
        ...
        //   // y: bound.top + bound.height - bound.width * Math.sqrt(3) - 100,
        //   x: bound.left - 100,
        //   y: bound.top + bound.height + 100
        // }
        // const p2 = {
        //   // x: bound.left - bound.height / Math.sqrt(3) - 100,
        //   // y: bound.top + bound.height + 100,
        //   x: bound.left + bound.width + bound.height + 100,
        //   y: bound.top + bound.height + 100
        // }
        // const p3 = {
        //   // x: bound.left + bound.width + bound.height / Math.sqrt(3) + 100,
        //   // y: bound.top + bound.height + 100
        //   x: bound.left - 100,
        //   y: bound.top - bound.width - 200
        // }
