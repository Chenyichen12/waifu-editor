<template>
    <VueDraggable class="drag-area" tag="ul" v-model="list" group="g1" @add="onAdd(modelValue,parentName)" >
      <!-- 导入了v-draggable -->
...
// 列表函数与属性
  ...
  //在改变后记录改变前后的父图层
  function onAdd(modelValue: IList[],parentname:string){
